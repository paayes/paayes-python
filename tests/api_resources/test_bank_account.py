...
class TestBankAccountTest(object):
    def construct_resource(self, **params):
        ...
        return paayes.BankAccount.construct_from(bank_dict, paayes.api_key)
    ...
    def test_is_not_retrievable(self):
        with pytest.raises(NotImplementedError):
            paayes.BankAccount.retrieve(TEST_RESOURCE_ID)
    ...
    def test_is_verifiable(self, request_mock):
        ...
        request_mock.assert_requested(
            "post",
            "/api/v1/customers/cus_123/sources/%s/verify" % TEST_RESOURCE_ID,
        )
