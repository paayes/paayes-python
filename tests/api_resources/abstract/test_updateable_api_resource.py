...
class TestUpdateableAPIResource(object):
    class MyUpdateable(paayes.api_resources.abstract.UpdateableAPIResource):
    ...
    def test_save(self, request_mock, obj):
        ...
        request_mock.stub_request(
            "post", "/api/v1/myupdateables/myid", {"id": "myid", "thats": "it"}
        )
        ...
        request_mock.assert_requested(
            "post", "/api/v1/myupdateables/myid", {"thats": "it"}, None
        )
        ...
        request_mock.assert_requested(
            "post", "/api/v1/myupdateables/myid", {"thats": "updated"}, None
        )
    ...
    def test_array_none(self, request_mock, obj):
        ...
        request_mock.assert_requested(
            "post", "/api/v1/myupdateables/myid", {"foo": "bar"}, None
        )
    ...
    def test_retrieve_and_update_with_paayes_version(self, request_mock, obj):
        request_mock.stub_request(
            "get", "/api/v1/myupdateables/foo", {"id": "foo", "bobble": "scrobble"}
        )

        res = self.MyUpdateable.retrieve("foo", paayes_version="2017-08-15")

        request_mock.assert_api_version("2017-08-15")

        request_mock.stub_request(
            "post",
            "/api/v1/myupdateables/foo",
