...
class MultipartDataGenerator(object):
    ...
    def add_params(self, params):
        ...
        params = dict(paayes.api_requestor._api_encode(params))

        for key, value in paayes.six.iteritems(params):
            if value is None:
                continue
            ...
            if hasattr(value, "read"):
                ...
                if hasattr(value, "name"):
                    ...
                    filename = paayes.six.text_type(value.name)
    ...
    def _write(self, value):
        if isinstance(value, paayes.six.binary_type):
            array = bytearray(value)
        elif isinstance(value, paayes.six.text_type):
