...
from paayes import api_requestor, connect_api_base, error
from paayes.six.moves.urllib.parse import urlencode
...
class OAuth(object):
    ...
    def _set_client_id(params):
        ...
        raise error.AuthenticationError(
            ...
            '"paayes.client_id = <CLIENT-ID>"). You can find your client_ids '
            "in your Paayes dashboard at "
            "https://dashboard.paayes.com/account/applications/settings, "
            "after registering your account as a platform. See "
            "https://docs.paayes.com/docs/connect/standalone-accounts for details, "
